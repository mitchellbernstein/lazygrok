...
//
//   node "<skill-root>/scripts/team.mjs" init        --name "<team>" --session-name "<sess>" [--transport spawn_subagent|codex_app] [--session <id>] [--worktree] [--base-branch dev]
...
//   node "<skill-root>/scripts/team.mjs" bind-agent   --team <id> --id A --agent-path /root/<task_name> [--cwd <path>]   (spawn_subagent teams)
