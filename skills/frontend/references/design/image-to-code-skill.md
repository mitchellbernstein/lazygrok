...
- On Grok, bias strongly toward larger, more analyzable section images.
...
On Grok, prefer separate large images per section.
...
On Grok, these should usually become section-by-section images, not one compressed sheet.
